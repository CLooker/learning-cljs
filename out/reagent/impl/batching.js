...
var c_2513 = (a[i]);
if(cljs.core.truth_((c_2513["cljsIsDirty"]))){
(c_2513["forceUpdate"])();
} else {
}
...
var G__2516 = c;
var G__2516__$1 = (((G__2516 == null))?null:(G__2516["props"]));
if((G__2516__$1 == null)){
return null;
} else {
return (G__2516__$1["argv"]);
}
});
...
if((!((derefed == null)))){
(c["cljsRatom"] = reagent.ratom.make_reaction.call(null,run,new cljs.core.Keyword(null,"auto-run","auto-run",1958400437),(function (){
...
var G__2517_2518 = (c["cljsRatom"]);
if((G__2517_2518 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__2517_2518);
}
