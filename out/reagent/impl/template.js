...
var temp__5459__auto__ = reagent.impl.template.obj_get.call(null,reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
...
var G__829 = o;
(G__829[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__830__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__830 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__831__i = 0, G__831__a = new Array(arguments.length -  0);
while (G__831__i < G__831__a.length) {G__831__a[G__831__i] = arguments[G__831__i + 0]; ++G__831__i;}
  args = new cljs.core.IndexedSeq(G__831__a,0,null);
} 
return G__830__delegate.call(this,args);};
G__830.cljs$lang$maxFixedArity = 0;
G__830.cljs$lang$applyTo = (function (arglist__832){
var args = cljs.core.seq(arglist__832);
return G__830__delegate(args);
});
G__830.cljs$core$IFn$_invoke$arity$variadic = G__830__delegate;
return G__830;
})()
;
} else {
...
if((!((class$ == null)))){
var old_833 = (p["className"]);
(p["className"] = (((!((old_833 == null))))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(old_833)].join(''):class$));
} else {
}
...
reagent.impl.batching.do_later.call(null,(function (){
...
if(cljs.core.truth_((function (){var and__4174__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__835 = jsprops;
(G__835["defaultValue"] = value);

(G__835["onChange"] = (function (p1__834_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__834_SHARP_);
}));
...
var vec__836 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__836,(0),null);
var id = cljs.core.nth.call(null,vec__836,(1),null);
var class$ = cljs.core.nth.call(null,vec__836,(2),null);
...
throw (new Error(["Assert failed: ",["Expected a function, not ",cljs.core.pr_str.call(null,f)].join(''),"\n","(ifn? f)"].join('')));
}

if((((!((!(((cljs.core.fn_QMARK_.call(null,f)) && ((!(((f["type"]) == null)))))))))) && ((typeof console !== 'undefined')))){
console.warn(["Warning: ","Using native React classes directly in Hiccup forms ","is not supported. Use create-element or ","adapt-react-class instead: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((f["type"])),reagent.impl.component.comp_name.call(null)].join(''));
} else {
}
...
var temp__5459__auto__ = reagent.impl.util.cached_react_class.call(null,tag);
if((temp__5459__auto__ == null)){
...
var temp__5459__auto__ = (function (){var G__839 = cljs.core.meta.call(null,v);
if((G__839 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__839);
}
})();
if((temp__5459__auto__ == null)){
...
var jsprops = ({"argv": v});
var G__840_841 = v;
var G__840_842__$1 = (((G__840_841 == null))?null:reagent.impl.template.key_from_vec.call(null,G__840_841));
if((G__840_842__$1 == null)){
} else {
(jsprops["key"] = G__840_842__$1);
}
...
var temp__5459__auto__ = reagent.impl.template.obj_get.call(null,reagent.impl.template.tag_name_cache,cljs.core.name.call(null,x));
if((temp__5459__auto__ == null)){
...
var temp__5457__auto__ = reagent.impl.template.cached_parse.call(null,tag);
...
var p = (function (){var temp__5459__auto__ = (function (){var G__843 = cljs.core.meta.call(null,argv);
if((G__843 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__843);
}
})();
if((temp__5459__auto__ == null)){
return jsprops;
...
var G__844 = (((jsprops == null))?({}):jsprops);
(G__844["key"] = key);
...
throw (new Error(["Assert failed: ",["Hiccup form should not be empty: ",cljs.core.pr_str.call(null,v),reagent.impl.component.comp_name.call(null)].join(''),"\n","(pos? (count v))"].join('')));
}

var tag = cljs.core.nth.call(null,v,(0));
if(reagent.impl.template.valid_tag_QMARK_.call(null,tag)){
} else {
throw (new Error(["Assert failed: ",["Invalid Hiccup form: ",cljs.core.pr_str.call(null,v),reagent.impl.component.comp_name.call(null)].join(''),"\n","(valid-tag? tag)"].join('')));
}

var temp__5459__auto__ = reagent.impl.template.native_element.call(null,tag,v);
if((temp__5459__auto__ == null)){
...
var n__4666__auto___845 = a.length;
var i_846 = (0);
while(true){
if((i_846 < n__4666__auto___845)){
(a[i_846] = reagent.impl.template.as_element.call(null,(a[i_846])));
...
var a = cljs.core.into_array.call(null,s);
var n__4666__auto___848 = a.length;
var i_849 = (0);
while(true){
if((i_849 < n__4666__auto___848)){
var val_850 = (a[i_849]);
if(((cljs.core.vector_QMARK_.call(null,val_850)) && ((reagent.impl.template.key_from_vec.call(null,val_850) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_849] = reagent.impl.template.as_element.call(null,val_850));
...
var ctx = ({});
var res = (((reagent.ratom._STAR_ratom_context_STAR_ == null))?reagent.impl.template.expand_seq_dev.call(null,x,ctx):reagent.ratom.capture_derefed.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}),ctx));
if(cljs.core.truth_(reagent.ratom.captured.call(null,ctx))){
if((typeof console !== 'undefined')){
console.warn(["Warning: ","Reactive deref not supported in lazy seq, ","it should be wrapped in doall",reagent.impl.component.comp_name.call(null),". Value:\n",cljs.core.pr_str.call(null,x)].join(''));
} else {
}
} else {
}
...
if((typeof console !== 'undefined')){
console.warn(["Warning: ","Every element in a seq should have a unique ",":key",reagent.impl.component.comp_name.call(null),". Value: ",cljs.core.pr_str.call(null,x)].join(''));
} else {
}
} else {
}
...
var G__852 = (cljs.core.count.call(null,argv) - first_child);
switch (G__852) {
case (0):
